             ...
             and write the content -->
                ...
                <div class="slide">
                    <h1 class="slide-number">
                        <img src="pages/slideshow_images/image_5.jpg" alt="Avatar" style="width:728px;height:600px;">
                    </h1>
                </div>
                <div class="slide">
                    <h1 class="slide-number">
                        <img src="pages/slideshow_images/image_6.jpg" alt="Avatar" style="width:728px;height:600px;">
                    </h1>
                </div>
                <div class="slide">
                    <h1 class="slide-number">
                        <img src="pages/slideshow_images/image_7.jpg" alt="Avatar" style="width:728px;height:600px;">
                    </h1>
                </div>
                <div class="slide">
                    <h1 class="slide-number">
                        <img src="pages/slideshow_images/image_4.jpg" alt="Avatar" style="width:728px;height:600px;">
                    </h1>
                </div>
            </div>
        <hr/><hr/>
