...
var k = 0; 
var divElement_c2 = [];
divElement_c2[k] = document.createElement('div');
divElement_c2[k].setAttribute('id', 'flex-container_2');
var div_cont = document.getElementById("dyn-cont");
div_cont.appendChild(divElement_c2[k]);
...
for (var i = 0; i < text_1.length; i++) {
    ...
    if ((i > 0) && (i % 3 == 0)){
        ...
        divElement_c2[k].appendChild(divElement_c21);
